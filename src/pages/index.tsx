  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Information System, your comprehensive solution for managing employee data, vacations, and payroll with ease and precision."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System, your comprehensive solution for managing employee data, vacations, and payroll with ease and precision.`}
            </Text>
            <Box
